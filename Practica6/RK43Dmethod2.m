% Este scrip lo usaremos al atractor de rossler b)
% Definimos una función, donde f, g, h son las respectivas ecuaciones 

function[t,x,y,z]=RK43Dmethod2(f,g,h,a,b,x0,y0,z0,stp)

% Discretizar el dominio
t=a:stp:b; 
n=size(t,2);

% Reservamos memoria en la compu para guardar la solución
x=zeros(1,n);
y=zeros(1,n);
z=zeros(1,n);
